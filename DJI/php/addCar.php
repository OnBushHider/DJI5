<?php
    ...
    $sql = "SELECT *  FROM `购物车` WHERE `userName` = '$userName' AND `goods_id` = '$goods_id'";
    ...
    if(!$row){
        ...
        // 把这条数据添加到购物车表
        $addSql = "INSERT INTO `购物车` VALUES (null, '$userName', '$goods_id', '1')";
        ...
        $updat = "UPDATE `购物车` SET `goods_num` = '$goods_num' WHERE `userName` = '$userName' AND `goods_id` = '$goods_id'";
